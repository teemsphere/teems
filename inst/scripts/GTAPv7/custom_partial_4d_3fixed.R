# 4D variable (atall: MARGm x COMMc x REGs x REGd), 3 dims fixed
# reduce_shock picks free_idx=[MARGm] (k=1)
# write_ragged: single-column branch (1 row, MARGm size=1)
...
# Fix COMMc="crops", REGs="chn", REGd="usa"; free dim MARGm(1), n=1

...
#'   shocks, list of objects produced by [`ems_uniform_shock()`],
#'   [`ems_custom_shock()`], or [`ems_scenario_shock()`] (default
...
#'   final shock file (default is `NULL`). No checks or
...
#'   `".data"`.
#' @seealso [`ems_uniform_shock()`], [`ems_custom_shock()`], and 
#' [`ems_scenario_shock()`] for generating the input to `"shock"`.

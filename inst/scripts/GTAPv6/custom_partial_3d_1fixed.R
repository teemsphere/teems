# 3D variable (afeall: ENDW_COMMi x PROD_COMMj x REGr), 1 dim fixed
# reduce_shock picks free_idx=[ENDW_COMMi, REGr] (k=2, no blk)
# write_ragged: dcast row=REGr ~ col=ENDW_COMMi -> 3x4 matrix
...
# Fix PROD_COMMj="crops"; free dims are ENDW_COMMi(4) x REGr(3), n=12

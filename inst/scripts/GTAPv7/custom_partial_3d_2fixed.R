# 3D variable (afeall: ENDWe x ACTSa x REGr), 2 dims fixed
...
# Fix ENDWe="labor" AND ACTSa="crops"; free dim is REGr(3), n=3
# reduce_shock: free_idx=[REGr], k=1
afeall <- afeall_full[
  afeall_full$ENDWe == "labor" & afeall_full$ACTSa == "crops",
]

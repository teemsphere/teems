# 4D variable (atall: MARG_COMMm x TRAD_COMMi x REGr x REGs), 3 dims fixed
...
# Fix TRAD_COMMi="crops", REGr="chn", REGs="usa"; free dim MARG_COMMm(1), n=1
# reduce_shock: free_idx=[MARG_COMMm], k=1
atall <- atall_full[
